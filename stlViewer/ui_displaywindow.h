...
public:
    ...
    {
        DisplayWindow->setWindowTitle(QApplication::translate("DisplayWindow", "DisplayWindow", Q_NULLPTR));
        pushButton->setText(QApplication::translate("DisplayWindow", "Go back", Q_NULLPTR));
    } // retranslateUi
